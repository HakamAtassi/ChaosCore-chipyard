...
class DigitalTop(implicit p: Parameters) extends ChipyardSystem
  ...
  with ChaosCore.CanHavePeripheryPPM // Enables optionally adding the PPM frame generator 
  with ChaosCore.CanHavePeripherySDL2 // Enables optionally adding the PPM frame generator 
